...
export PATH=$PATH:/home/kent/javaEnv/mvnd/bin:/home/kent/javaEnv/maven3/bin:$ORACLE_HOME/bin:/home/kent/javaEnv/ant/bin:$HOME/bin:/home/kent/.npm_modules/bin:/home/kent/Desktop/Projects/Aviatar/openshift/
...
if [[ $TERM == "linux" ]] ; then
    /bin/setfont /usr/share/kbd/consolefonts/solar24x32.psfu.gz
fi
